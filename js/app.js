...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const DOM = {
        ...
        // Abas Nota de Amor / Letra
        tabBtnMessage: document.getElementById('tab-btn-message'),
        tabBtnLyrics: document.getElementById('tab-btn-lyrics'),
    ...
    function initializeExperience() {
        ...
        // Inicializa a Interface de Letra Sincronizada
        LyricsUI.init('lyrics-scroll', 'btn-toggle-translation');
        ...
        player.bindEvents({
            ...
            onTrackChange(track) {
                ...
                // Atualiza a letra sincronizada da nova faixa
                LyricsUI.loadTrack(track);
            ...
            onTimeUpdate(currentTime, duration) {
                ...
                // Sincroniza a linha ativa da letra com o tempo de reprodução
                LyricsUI.update(currentTime);
            },
        ...
        // Alternância entre as abas "Nota de Amor" e "Letra"
        DOM.tabBtnMessage.addEventListener('click', () => {
            DOM.tabBtnMessage.classList.add('active');
        ...
        DOM.tabBtnLyrics.addEventListener('click', () => {
            DOM.tabBtnLyrics.classList.add('active');
            DOM.tabBtnMessage.classList.remove('active');
